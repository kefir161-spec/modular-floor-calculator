...
export const tokens = {
  color: {
    ...
    /** Окантовка: прямой кант №1 / №2 и угловой элемент */
    edgingStraight1: '#6b7480',
    edgingStraight2: '#8d97a3',
    edgingCorner: '#48505a',
    edgingJoint: 'rgba(255, 255, 255, 0.55)',
    contour: '#1d4f7a',
...
export function tokensToCssVariables(source: DesignTokens = tokens): Record<string, string> {
  return {
    ...
    '--pf-color-edging-straight-1': source.color.edgingStraight1,
    '--pf-color-edging-straight-2': source.color.edgingStraight2,
    '--pf-color-edging-corner': source.color.edgingCorner,
...
export const KONVA_THEME = {
  ...
  edgingStraight1: tokens.color.edgingStraight1,
  edgingStraight2: tokens.color.edgingStraight2,
  edgingCorner: tokens.color.edgingCorner,
  edgingJoint: tokens.color.edgingJoint,
} as const
